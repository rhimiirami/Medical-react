...
retryImport(() =>
  import(/* webpackChunkName: "LoginComponent" */ '../pfa/LoginComponent/Login.js')
)
);
const RegisterComponent = asyncComponent(() =>
retryImport(() =>
  import(/* webpackChunkName: "RegisterComponent" */ '../pfa/RegisterComponent/Register.js')
)
);
